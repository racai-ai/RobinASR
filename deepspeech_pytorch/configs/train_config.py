...
class AugmentationConfig:
    ...
    noise_max: float = 0.3  # Maximum noise levels to sample from. Maximum 1.0
...
class BiDirectionalConfig:
    ...
    hidden_size: int = 768  # Hidden size of RNN Layer
    hidden_layers: int = 4  # Number of RNN layers
...
class OptimConfig:
    ...
    learning_anneal: float = 1.05  # Annealing applied to learning rate after each epoch
